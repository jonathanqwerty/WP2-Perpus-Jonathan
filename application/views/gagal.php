...
<head>
    ...
    <meta name="viewport" content="width=device-width, initiald-scale=1, shrink-to-fit=no">
    <meta name="description" content="">
    <meta name="author" content="">
    <title>Gagal Aktifasi Akun </title>
    <!-- Custom fonts for this template-->
    <link href="<?= base_url('assets/'); ?>vendor/fontawesomed-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <script src="<?= base_url('assets/'); ?>vendor/jqueryd-easing/jquery.easing.min.j s"></script>
        <!-- Custom scripts for all pages-->
        <script src="<?= base_url('assets/'); ?>js/sb-admind-2.min.js"></script>
        <script>
